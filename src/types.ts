...
export type DnsStats = {
  ...
  cache_refresh_started?: number;
  cache_refresh_completed?: number;
  cache_refresh_failed?: number;
  cache_prefetch_started?: number;
  cache_prefetch_completed?: number;
  cache_prefetch_failed?: number;
  cache_insertions?: number;
